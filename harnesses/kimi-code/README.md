...
| --- | --- |
| Adapter ID | `kimi-code` |
| Native executable | `kimi` |
| Provider command | `kimi-<alias>` |
| Role selection | `harness-sync run kimi-code --provider <alias> --role simple\|daily\|complex -- ...` |
